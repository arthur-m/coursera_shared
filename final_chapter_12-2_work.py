# this is my working, final & submitted version.
...
for i in range(count):  #  how many times we do this entire process
    ...
    # calling the soup object itself is equivalent to calling findAll()
    # on the soup object -- it's just a shorthand for the same action.
