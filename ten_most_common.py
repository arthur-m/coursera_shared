...
# we can rewire the above four lines of code in one line:

l = sorted([(val, key) for key, val in counts.items()], reverse=True)
...
# we could even throw the sorted into the list comp, duh!
